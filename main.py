...
class Calculator:
    def __init__(self, main):
        ...
        self.button_clear = ttk.Button(self.main, text="C", command=self.button_clear)
        self.button_add = ttk.Button(self.main, text="+", command=self.button_add)
        self.button_equal = ttk.Button(self.main, text="=", command=self.button_equal)
        self.button_subtract = ttk.Button(self.main, text="-", command=self.button_subtract)
        self.button_multiply = ttk.Button(self.main, text="*", command=self.button_multiply)
        self.button_divide = ttk.Button(self.main, text="/", command=self.button_divide)
        self.button_floor_div = ttk.Button(self.main, text="//", command=self.button_floor_div)
        self.button_modulus = ttk.Button(self.main, text="%", command=self.button_modulus)
        self.button_sqrt = ttk.Button(self.main, text="√", command=self.button_sqrt)
        self.button_neg = ttk.Button(self.main, text="+/-", command=self.button_neg)
